...
let stateObj = { index: "index.php" };

// let scrollPosition

const openModal = function (e) {
    e.preventDefault()
    history.replaceState(stateObj, "index.php", "index.php#modal-share-photos");
...
const closeModal = function (e) {
    ...
    e.preventDefault()
    history.replaceState(stateObj, "#modal-share-photo", "index.php");
    if (fileList.length) {
...
let submitButton = document.querySelector("#valid-upload-photo")
