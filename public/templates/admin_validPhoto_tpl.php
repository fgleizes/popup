	...
	<body>
		<main>
			<section id="valid-photo">
                <a href="admin.php" class="button white-button">Retour à l'administration</a>
                <form method="post" action="../src/admin_editPhoto.php?photo_Id=<?= $photo["id"] ?>">
                    <div id="infos-photo">
                        ...
                        <div id="details-photo">
                            ...
                            <div>
                                ...
                                <!-- <p><?= date ("Y-m-d H:i:s", $photo["lastModified"]) ?></p> -->
                                <p><?= date ("Y-m-d H:i:s", $fileLastModifiedDate) ?></p>
                                <h4>Partagée le :</h4>
                    ...
                    <div id="choices-photo">
                        ...
                        <div id="choice-category">
                            ...
                            <!-- <form action="add_category.php" method="post">
                                <label for="category">Ajoutez une nouvelle catégorie : <i class="fas fa-plus-circle"></i> </label>
                        ...
                        <div id="valid">
                            <a href="admin.php" class="button white-button">Retour</a>
                            <input type="submit" value="Publier la photo" class="button black-button">
                        </div>
                    </div>
                </form>
            </section>
